...
{ 
  ...
  analysisManager->CreateH1("Eabs","Energy Deposit in abs 01", 100, 0., 3.*MeV);
  analysisManager->CreateH1("Eabs","Energy Deposit in abs 02", 100, 0., 3.*MeV);
  analysisManager->CreateH1("Egap","Energy Deposit in gap", 100, 0., 3.*MeV);
  analysisManager->CreateH1("Labs","Track Length in abs 01", 100, 0., 10*mm);
  analysisManager->CreateH1("Labs","Track Length in abs 01", 100, 0., 10*mm);
