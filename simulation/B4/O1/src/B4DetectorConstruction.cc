...
G4VPhysicalVolume* B4DetectorConstruction::DefineVolumes()
{
  ...
  fAbsorberPV
    = new G4PVPlacement(
                 0,                // no rotation
		 G4ThreeVector(0.,0.,+block_absoThickness/2),  // at (0,0,0)
  ...
  fAbsorberPV
     = new G4PVPlacement(
			 0,                // no rotation
			 G4ThreeVector(0.,0.,+block_absoThickness/2+empty_Si+block_absoThickness),  // at (0,0,0)
			 absorberLV,       // its logical volume                       
			 "Abso_2",           // its name
			 layerLV,          // its mother  volume
			 false,            // no boolean operation
    ...
    fAbsorberPV
      = new G4PVPlacement(
			  0,                // no rotation
			  G4ThreeVector(0.,0.,+block_absoThickness/2+2*empty_Si+2*block_absoThickness),  // at (0,0,0)
			  absorberLV,       // its logical volume                      
			  "Abso_3",           // its name
			  layerLV,          // its mother  volume
			  false,            // no boolean operation
  ...
  fFilmPV
    = new G4PVPlacement(
                 0,                // no rotation
                 G4ThreeVector(0., 0., +filmThickness/2), // its position
  ...
  fFilmPV
    = new G4PVPlacement(
		 0,                // no rotation
		 G4ThreeVector(0., 0., +filmThickness/2+absoThickness+filmThickness/2), // its position
		 filmLV,            // its logical volume
		 "FilmOut_1",            // its name
		 layerLV,          // its mother  volume
		 false,            // no boolean operation
     ...
     fFilmPV
       = new G4PVPlacement(
			   0,                // no rotation
			   G4ThreeVector(0., 0., +filmThickness/2+block_absoThickness+empty_Si), // its position
			   filmLV,            // its logical volume
			   "FilmIn_2",            // its name
			   layerLV,          // its mother  volume
			   false,            // no boolean operation
	 ...
	 = new G4PVPlacement(
			     0,                // no rotation
			     G4ThreeVector(0., 0., +filmThickness/2+absoThickness+filmThickness/2+block_absoThickness+empty_Si), // its position
			     filmLV,            // its logical volume
			     "FilmOut_2",            // its name
			     layerLV,          // its mother  volume
			     false,            // no boolean operation
	      ...
	      = new G4PVPlacement(
				  0,                // no rotation
				  G4ThreeVector(0., 0., +filmThickness/2+2*block_absoThickness+2*empty_Si), // its position
				  filmLV,            // its logical volume
				  "FilmIn_3",            // its name
				  layerLV,          // its mother  volume
				  false,            // no boolean operation
		     ...
		     = new G4PVPlacement(
					 0,                // no rotation
					 G4ThreeVector(0., 0., +filmThickness/2+absoThickness+filmThickness/2+2*block_absoThickness+2*empty_Si), // its position
					 filmLV,            // its logical volume
					 "FilmOut_3",            // its name
					 layerLV,          // its mother  volume
					 false,            // no boolean operation
  ...
  //
	...
	= new G4Box("Isotope",             // its name
		...
		= new G4PVPlacement(
				    0,                // no rotation
				    G4ThreeVector(0., 0.,3*block_absoThickness+2*empty_Si+empty_Se+isoThickness/2), // its position
