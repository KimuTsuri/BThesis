{
  ...
  B4->SetBranchAddress("Eabs47",&EabsEr0);
  B4->SetBranchAddress("Eabs48",&EabsEr1);
  B4->SetBranchAddress("Eabs49",&EabsEr2);
  B4->SetBranchAddress("Eabs50",&EabsEr3);
  B4->SetBranchAddress("Eabs51",&EabsEr4);
  
  B4->SetBranchAddress("Eabs53",&EabsEr5);
  B4->SetBranchAddress("Eabs54",&EabsEr6);
  B4->SetBranchAddress("Eabs55",&EabsEr7);
  B4->SetBranchAddress("Eabs56",&EabsEr8);
  B4->SetBranchAddress("Eabs57",&EabsEr9);
